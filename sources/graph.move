...
module tensorflowsui::graph {
    ...
    use tensorflowsui::tensor::{
        ...
        create_signed_fixed, scale_up, from_input,
    ...
    // SignedFixedLayer struct and related functions
    ...
    // SignedFixedGraph struct and related functions
    ...
    // PartialDense and PartialDenses structs and related functions
    ...
    public fun add_partial_for_layer(
