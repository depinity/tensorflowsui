...
`;
    ...
    await fsPromises.writeFile('./without_git_dependencies/Move.toml', moveTomlContent, 'utf-8');
...
async function publishToNet() {
    ...
    const contractURI = path.resolve("./without_git_dependencies");
...
async function main() {
    try {
        ...
        // Changed path from './sui' to './without_git_dependencies'
        await fsPromises.mkdir('./without_git_dependencies/sources', { recursive: true });
        await fsPromises.writeFile('./without_git_dependencies/sources/model.move', moveCode);
        console.log("Move code generated and saved to ./without_git_dependencies/sources/model.move");
